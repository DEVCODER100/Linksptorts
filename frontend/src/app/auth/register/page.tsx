...
const ROLE_COPY: Record<string, { heading: string; sub: string }> = {
  athlete: {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="card p-8">
          ...
          <p className="text-gray-500 text-sm mb-6">
            {roleCopy ? roleCopy.sub : 'Sign up with Google to get started.'}
          </p>
          ...
          <div className="space-y-5">
            ...
            {/* Continue with Google (requires accepting terms) */}
            <a
              ...
              className={`w-full flex items-center justify-center gap-3 border rounded-lg py-3 text-sm font-medium transition-colors ${
                termsAccepted
