          ...
          <div className="hidden md:flex items-center gap-1">
            {isAuthenticated ? (
              <>
                ...
                {!isAdmin && (
                  <>
                    ...
                    <Link href="/predictor" className="nav-link px-3 py-2 rounded-lg text-sm font-semibold text-brand hover:bg-blue-50 transition-colors flex items-center gap-1">
              ...
              <>
                ...
                <Link href="/predictor" className="px-3 py-2 text-sm font-semibold text-brand hover:text-brand-dark flex items-center gap-1"><Trophy className="w-4 h-4" /> Predictions</Link>
            ...
            {isAuthenticated ? (
              isAdmin ? (
                ...
                <>
                  ...
                  <Link href="/predictor" className="block px-3 py-2 rounded-lg text-sm font-semibold text-brand hover:bg-blue-50" onClick={() => setIsMenuOpen(false)}>🏆 Predictions</Link>
