      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-1">
            {isAuthenticated ? (
              <>
                {/* Opportunities & Network — hidden for admin */}
                {!isAdmin && (
                  <>
                    ...
                    <Link href="/predictor" className="fifa-pop px-3 py-2 rounded-lg text-sm font-bold text-white bg-brand hover:bg-brand-dark transition-colors flex items-center gap-1 shadow-sm">
                      <Trophy className="w-4 h-4" /> FIFA26
                    </Link>
                  </>
                )}
              ...
              <>
                ...
                <Link href="/predictor" className="fifa-pop px-3 py-2 rounded-lg text-sm font-bold text-white bg-brand hover:bg-brand-dark transition-colors flex items-center gap-1 shadow-sm"><Trophy className="w-4 h-4" /> FIFA26</Link>
        ...
        <div className="md:hidden border-t border-gray-200 bg-white">
          <div className="px-4 py-3 space-y-1">
            ...
            {isAuthenticated ? (
              isAdmin ? (
                <>
                  <Link href="/admin" className="block px-3 py-2 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-100" onClick={() => setIsMenuOpen(false)}>Admin Panel</Link>
                ...
                <>
                  ...
                  <Link href="/predictor" className="fifa-pop inline-flex w-fit px-3 py-2 rounded-lg text-sm font-bold text-white bg-brand hover:bg-brand-dark shadow-sm" onClick={() => setIsMenuOpen(false)}>🏆 FIFA26</Link>
